...
- **Home Page**: Griglia responsive con il catalogo dei film.
- **Dettaglio Film**: Scheda del singolo film con media voti ed elenco delle recensioni.
- **API REST & DB**: Server Express collegato a un database MySQL per la gestione dei dati.
